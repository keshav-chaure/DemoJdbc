...
public class App {
	...
	public static void main(String[] args)
		 ...
		 * 
		 * psInsert.setString(1, "some"); psInsert.setString(2, "Pune");
		 * 
		 * psInsert.executeUpdate();
		 */

		/*
		 * conn=DerbyConnection.getDerbyConnection(); Statement stmt2 =
		 * conn.createStatement(); ResultSet rs =
		 * stmt2.executeQuery("select * from ADDRESSBOOKTbl");
		 * System.out.println("Addressed present in your Address Book\n\n"); int
		 * num = 0;
		 * 
		 * while (rs.next()) { System.out.println(++num + ": Name: " +
